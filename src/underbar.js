(function() {
  ...
  _.last = function(array, n) {
    return n > array.length ? array
      : n === 0 ? []
        : n === undefined ? array.slice( array.length - 1 )
  ...
  //if array
  //itterate overvalues
  // call itterator with value, index, collection
  //else
  // itterate over keys
  //run itterator with collection at key,key, collection
  ...
  // create return empty arr
  //. each on collection with finction
  // push to result arr vale with  iterator run on it
  ...
  _.reduce = function(collection, iterator, accumulator) {
    // determine if accumulator is not defined,
  ...
  _.delay = function(func, wait) {
    var tureArgs = Array.prototype.slice.call(arguments);
    var slicedArgs = tureArgs.slice(2);
    setTimeout(function() {
  ...
  _.shuffle = function(array) {
    ...
    while (arr.length < array.length) {
      ...
      if (obj[randomIndex] === undefined ) {
        arr.push(array[randomIndex]);
        obj[randomIndex] = true;
      }
    }
    return arr;
  };
